...
*Updated by Katherine Muller, October 2025*
...
library(agridat)
```
Below are many nearly identical code chunks, all containing some error.  Can you troubleshoot these errors? When you think you've done it, remove "eval = FALSE" from the code chunk and try to knit.
